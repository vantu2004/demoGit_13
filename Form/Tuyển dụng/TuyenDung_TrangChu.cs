    ...
    public partial class TuyenDung_TrangChu : Form
    {
        ...
        public void Btn_hoanTat_Click1(object sender, EventArgs e)
        {
            ...
            if (kiemTra_null())
            {
                ...
                TuyenDung_Tin t = new TuyenDung_Tin(IdCompany, g.ToString(), "Employer", this.linkLogo, UC_taoTin.tbx_tenCongTy.Text, UC_taoTin.tbx_mangXaHoi.Text, UC_taoTin.tbx_diaChi.Text, UC_taoTin.cbx_nganhNghe.Text, UC_taoTin.tbx_tenCongViec.Text, 
