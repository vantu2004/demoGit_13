...
namespace Project_Windows_04
{
    public partial class Main_TrangChu : Form
    {
        ...
        private void Main_TrangChu_Load(object sender, EventArgs e)
        {
            ...
            UC_Main_TrangChu.cbx_loc_nganhNghe.SelectedIndexChanged += UC_Main_TrangChu.locTheoDieuKien;
            UC_Main_TrangChu.cbx_loc_sapXep.SelectedIndexChanged += UC_Main_TrangChu.cbx_loc_sapXep_SelectedIndexChanged;
            UC_Main_TrangChu.cbx_loc_kinhNghiem.SelectedIndexChanged += UC_Main_TrangChu.locTheoDieuKien;
            UC_Main_TrangChu.cbx_loc_diaChi.SelectedIndexChanged += UC_Main_TrangChu.locTheoDieuKien;
